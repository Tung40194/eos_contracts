...
public:
    ...
    TABLE campaign.info {
        ...
        uint64_t endAt = 0;
        EOSLIB_SERIALIZE( campaign.info, (communityAccount)(donorPositionId)(startAt)(fundingEndAt)(endAt));
    };
    typedef eosio::singleton<"campaign.inf"_n, campaign.info> campaign_info_table;
